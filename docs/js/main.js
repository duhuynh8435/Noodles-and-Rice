...
function windowLoadInit() {
	...
	// 	var ajax = jQuery.post( "https://formspree.io/meqrnbbg", request )
	// 	.done(function( data ) {
...
$window.on('load', function(){
	...
	if ( $googleMaps.length ) {
		$googleMaps.each(function() {
			...
			var address2 = $map.data('address') ? $map.data('address') : 'london, baker street, 221b';
			var markerDescription = $map.find('.map_marker_description').prop('outerHTML');
			console.log("=========");
			console.log(markerIconSrc)
			...
			jQuery.getJSON('https://maps.googleapis.com/maps/api/geocode/json?address=' + address + '&key=AIzaSyBMCBKjQdxZCeFPyYIV_EgeawNueg5ewtI', function(data) {
